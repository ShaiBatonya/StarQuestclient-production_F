...
import { API_BASE_URL, IS_DEVELOPMENT, IS_PRODUCTION, MODE } from '@/config/environment';
...
export const EnvironmentDebug: React.FC = () => {
  return (
    <div className="fixed top-4 right-4 bg-slate-900/90 text-white p-4 rounded-lg border border-slate-700 text-xs max-w-md z-50">
      ...
      <button 
        onClick={() => console.log('Environment:', { API_BASE_URL, MODE, IS_DEVELOPMENT, IS_PRODUCTION })}
